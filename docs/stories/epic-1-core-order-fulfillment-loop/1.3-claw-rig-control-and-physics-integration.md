...
### Tasks / Subtasks
1. **Prototype Input Controller (AC: 1)** – Wire the virtual joystick vector, extend/close button hold+release flow, and retract button events into solver intents with latency tests. [Source: architecture/input-system-architecture.md#input-handling-patterns]
